...
4. Create a `requirements.txt` file in your backend folder with the following dependencies:
   ```text
   Flask==3.0.0
   Flask-Cors==4.0.0
   python-dotenv==1.0.0
...
6. Create a file named `.env` in the root of your backend directory to connect to your local Neo4j instance. Add the following credentials:
   ```env
